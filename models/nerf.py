...
class NeRFAll(nn.Module):
    ...
    def render_rays(self,
        ...
        if N_importance > 0:
            rgb_map_0, depth_map_0, acc_map_0, disp_map_0  = rgb_map, depth_map, acc_map, disp_map
    ...
    def forward(self, H, W, K, chunk=1024 * 32, rays=None, rays_info=None, poses=None, **kwargs):
        ...
        if self.training:
            ...
            return rgb, depth, extras['rgb0']
                
        #  evaluation
        else:
            assert poses is not None, "Please specify poses when in the eval model"
            rgb, depth, acc, extras = self.render_path(H, W, K, chunk, poses, **kwargs)
